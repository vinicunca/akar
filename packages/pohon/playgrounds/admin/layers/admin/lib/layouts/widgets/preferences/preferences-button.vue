...
import { PButton, PSlideover } from '#components';
import { preferences, updatePreferences } from '#layers/dashboard-storage/lib';
...
defineOptions({
  name: 'AdminDashboardLayoutPreferencesButton',
});
