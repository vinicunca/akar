    ...
    children: [
        ...
        children: [
          {
            ...
            component: () => import('../pages/demos/access/page-control.vue'),
            meta: {
        ...
        children: [
          {
            ...
            component: () =>
              import('../pages/demos/features/login-expired.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () => import('../pages/demos/features/icons.vue'),
            meta: {
              icon: 'lucide:annoyed',
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/watermark.vue'),
            meta: {
              icon: 'lucide:tags',
          ...
          },
          {
            ...
            component: () => import('../pages/demos/features/tabs.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/tabs/detail/[id].vue'),
            meta: {
            ...
            children: [
              {
                ...
                component: () =>
                  import(
                    '../pages/demos/features/hide-menu-children/index.vue',
                  ),
                meta: {
                  // hideInMenu: true,
                  title: 'pages.demos.features.hideChildrenInMenu',
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/full-screen.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/file-download.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/clipboard.vue'),
            meta: {
              icon: 'lucide:copy',
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/menu-query.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/new-window.vue'),
            meta: {
              icon: 'lucide:app-window',
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/vue-query.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import(
                '../pages/demos/features/request-params-serializer.vue',
              ),
            meta: {
              icon: 'lucide:git-pull-request-arrow',
          ...
          },
          {
            ...
            component: () =>
              import('../pages/demos/features/json-bigint.vue'),
            meta: {
              icon: 'lucide:grape',
              title: 'JSON BigInt',
            },
        ...
        children: [
          {
            ...
            component: () => import('../pages/demos/fallback/403.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () => import('../pages/demos/fallback/404.vue'),
            meta: {
              icon: 'mdi:table-off',
              title: '404',
            },
          },
          {
            ...
            component: () =>
              import('../pages/demos/fallback/500.vue'),
            meta: {
          ...
          },
          {
            ...
            component: () => import('../pages/demos/fallback/offline.vue'),
            meta: {
              icon: 'mdi:offline',
      ...
      // Badges
      {
        ...
        children: [
          {
            name: 'BadgeDotDemo',
            component: () => import('../pages/demos/badge/dot.vue'),
          ...
          {
            name: 'BadgeTextDemo',
            component: () => import('../pages/demos/badge/text.vue'),
          ...
          {
            name: 'BadgeColorDemo',
            component: () => import('../pages/demos/badge/color.vue'),
      ...
      // Active Icons
      {
        ...
        children: [
          {
            name: 'ActiveIconDemo',
            component: () => import('../pages/demos/active-icon/children.vue'),
        ...
        children: [
          {
            ...
            component: () => import('../pages/demos/nested/menu1.vue'),
            meta: {
              icon: 'ic:round-menu',
              keepAlive: true,
            ...
            children: [
              {
                ...
                component: () => import('../pages/demos/nested/menu2/menu2-1.vue'),
                meta: {
                  icon: 'ic:round-menu',
                  keepAlive: true,
            ...
            children: [
              {
                ...
                component: () => import('../pages/demos/nested/menu3/menu3-1.vue'),
                meta: {
                  icon: 'ic:round-menu',
                  keepAlive: true,
                ...
                children: [
                  {
                    ...
                    component: () =>
                      import('../pages/demos/nested/menu3/menu3-2/menu3-2-1.vue'),
                    meta: {
                      icon: 'ic:round-menu',
                      keepAlive: true,
