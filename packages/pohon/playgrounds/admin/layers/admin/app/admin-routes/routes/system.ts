    ...
    children: [
      {
        ...
        component: () => import('../pages/systems/roles.vue'),
      },
      {
        ...
        component: () => import('../pages/systems/menus.vue'),
      },
      {
        ...
        component: () => import('../pages/systems/depts.vue'),
      },
    ],
  },
  {
    component: () => import('../pages/systems/about.vue'),
    meta: {
