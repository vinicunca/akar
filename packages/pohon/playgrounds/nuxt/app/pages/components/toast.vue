...
<template>
  <Navbar>
    <PSwitch v-model="appConfig.toaster.disableSwipe" label="Disable swipe" />
    <PCheckbox v-model="appConfig.toaster.expand" label="Expand" />
    <PSelect v-model="appConfig.toaster.position" :items="positions" placeholder="Position" />
    <PInput v-model="appConfig.toaster.duration" placeholder="Duration" type="number" />
    <PInput v-model="appConfig.toaster.max" placeholder="Max" type="number" />
  </Navbar>
