  ...
  <Matrix v-slot="props" :attrs="attrs">
    ...
    >
      <template #leading="{ modelValue, ui }">
        <PIcon v-if="modelValue" :name="getStatusIcon(modelValue)" :class="ui.leadingIcon()" />
      </template>
    </PSelect>
    <PSelect
    ...
    >
      <template #leading="{ modelValue, ui }">
        <PAvatar v-if="modelValue" :size="(ui.itemLeadingAvatarSize() as AvatarProps['size'])" v-bind="getUserAvatar(modelValue)" />
      </template>
    </PSelect>
  </Matrix>
</template>
