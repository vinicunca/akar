...
<template>
  <Navbar>
    ...
    <PSelect v-model="attrs.animation" :items="animations" multiple />
  ...
  >
    <PProgress :orientation="orientation" v-bind="props" />
    <PProgress v-model="value2" :max="max" status :orientation="orientation" v-bind="props" />
    <PProgress
      v-model="value2"
      :max="max"
      status
