...
export const slideoverTheme = {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      side: 'right',
      class: {
        content: 'data-[state=open]:(animate-in) data-[state=open]:animate-[slide-in-from-right_200ms_ease-in-out] data-[state=closed]:animate-[slide-out-to-right_200ms_ease-in-out]',
      },
    },
    {
      transition: true,
...
} satisfies UvConfig<typeof pohon>['slideover'];
