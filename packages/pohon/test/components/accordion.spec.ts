import type { PAccordionProps, PAccordionSlots } from '../../src/runtime/components/accordion.vue';
...
describe('accordion', () => {
  ...
  it.each([
    ...
    ['with ui', { props: { ...props, pohon: { item: 'border-accented' } } }],
    // Slots
  ...
  ])('renders %s correctly', async (nameOrHtml: string, options: { props?: PAccordionProps; slots?: Partial<PAccordionSlots & { custom: () => 'Custom slot' } & { 'custom-body': () => 'Custom body slot' }> }) => {
