...
import type { ACalendarCellTriggerProps, ACalendarRootEmits, ACalendarRootProps, ARangeCalendarRootEmits, ARangeCalendarRootProps, DateRange } from 'akar';
...
const props = withDefaults(defineProps<PCalendarProps<R, M>>(), {
  fixedWeeks: true,
  monthControls: true,
  yearControls: true,
});
