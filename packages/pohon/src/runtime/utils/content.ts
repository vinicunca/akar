...
interface MapContentNavigationItemOptions { labelAttribute?: string; deep?: number }
...
export function mapContentNavigation(navigation: Array<ContentNavigationItem>, options?: MapContentNavigationItemOptions) {
