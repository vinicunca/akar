...
<script lang="ts">
import type { DropdownMenuRootProps, DropdownMenuRootEmits, DropdownMenuContentProps, DropdownMenuContentEmits, DropdownMenuArrowProps } from 'akar'
...
import { DropdownMenuRoot, DropdownMenuTrigger, DropdownMenuArrow, useForwardPropsEmits } from 'akar'
...
<template>
  <DropdownMenuRoot v-slot="{ open }" v-bind="rootProps">
    ...
    >
      ...
      <DropdownMenuArrow v-if="!!arrow" v-bind="arrowProps" :class="pohon.arrow({ class: props.pohon?.arrow })" />
    </UDropdownMenuContent>
  </DropdownMenuRoot>
</template>
