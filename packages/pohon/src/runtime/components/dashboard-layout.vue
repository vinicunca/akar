  ...
  >
    <slot name="sidebar">
      <PDashboardSidebar
        ...
        v-model:collapse="isSidebarCollapse"
        v-model:expand-on-hover="isSidebarExpandOnHover"
        v-model:expand-on-hovering="isSidebarExpandOnHovering"
        v-model:extra-collapse="isSidebarExtraCollapse"
        ...
        :fixed-extra="isSidebarExpandOnHover"
