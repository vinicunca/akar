...
<template>
  <APrimitive :as="as" :class="pohon.root({ class: [props.pohon?.root, props.class] })" :data-disabled="disabled ? true : undefined">
    <div :class="pohon.picker({ class: props.pohon?.picker })">
      <div
        ...
        :style="selectorStyle"
      >
        <div :class="pohon.selectorBackground({ class: props.pohon?.selectorBackground })" data-color-picker-background>
          <div
