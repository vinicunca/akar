...
export const AAutocomplete = {
  Root: AAutocompleteRoot,
  Input: AAutocompleteInput,
  Anchor: AAutocompleteAnchor,
  Empty: AAutocompleteEmpty,
  Trigger: AAutocompleteTrigger,
  Cancel: AAutocompleteCancel,
  Group: AAutocompleteGroup,
  Label: AAutocompleteLabel,
  Content: AAutocompleteContent,
  Viewport: AAutocompleteViewport,
  Virtualizer: AAutocompleteVirtualizer,
  Item: AAutocompleteItem,
  ItemIndicator: AAutocompleteItemIndicator,
  Separator: AAutocompleteSeparator,
  Arrow: AAutocompleteArrow,
  Portal: AAutocompletePortal,
} as {
  Root: typeof AAutocompleteRoot;
  Input: typeof AAutocompleteInput;
  Anchor: typeof AAutocompleteAnchor;
  Empty: typeof AAutocompleteEmpty;
  Trigger: typeof AAutocompleteTrigger;
  Cancel: typeof AAutocompleteCancel;
  Group: typeof AAutocompleteGroup;
  Label: typeof AAutocompleteLabel;
  Content: typeof AAutocompleteContent;
  Viewport: typeof AAutocompleteViewport;
  Virtualizer: typeof AAutocompleteVirtualizer;
  Item: typeof AAutocompleteItem;
  ItemIndicator: typeof AAutocompleteItemIndicator;
  Separator: typeof AAutocompleteSeparator;
  Arrow: typeof AAutocompleteArrow;
  Portal: typeof AAutocompletePortal;
};

export const AAvatar = {
  Fallback: AAvatarFallback,
  Image: AAvatarImage,
  Root: AAvatarRoot,
} as {
  Fallback: typeof AAvatarFallback;
  Image: typeof AAvatarImage;
  Root: typeof AAvatarRoot;
};
...
export const AContextMenu = {
  Arrow: AContextMenuArrow,
  CheckboxItem: AContextMenuCheckboxItem,
  Content: AContextMenuContent,
  Group: AContextMenuGroup,
  ItemIndicator: AContextMenuItemIndicator,
  Item: AContextMenuItem,
  Label: AContextMenuLabel,
  Portal: AContextMenuPortal,
  RadioGroup: AContextMenuRadioGroup,
  RadioItem: AContextMenuRadioItem,
  Root: AContextMenuRoot,
  Separator: AContextMenuSeparator,
  SubContent: AContextMenuSubContent,
  SubTrigger: AContextMenuSubTrigger,
  Sub: AContextMenuSub,
  Trigger: AContextMenuTrigger,
} as {
  Arrow: typeof AContextMenuArrow;
  CheckboxItem: typeof AContextMenuCheckboxItem;
  Content: typeof AContextMenuContent;
  Group: typeof AContextMenuGroup;
  ItemIndicator: typeof AContextMenuItemIndicator;
  Item: typeof AContextMenuItem;
  Label: typeof AContextMenuLabel;
  Portal: typeof AContextMenuPortal;
  RadioGroup: typeof AContextMenuRadioGroup;
  RadioItem: typeof AContextMenuRadioItem;
  Root: typeof AContextMenuRoot;
  Separator: typeof AContextMenuSeparator;
  SubContent: typeof AContextMenuSubContent;
  SubTrigger: typeof AContextMenuSubTrigger;
  Sub: typeof AContextMenuSub;
  Trigger: typeof AContextMenuTrigger;
};
...
export const AHoverCard = {
  ...
  Content: AHoverCardContent,
  Portal: AHoverCardPortal,
  Root: AHoverCardRoot,
  Trigger: AHoverCardTrigger,
} as {
  Arrow: typeof AHoverCardArrow;
  Content: typeof AHoverCardContent;
  Portal: typeof AHoverCardPortal;
  Root: typeof AHoverCardRoot;
  Trigger: typeof AHoverCardTrigger;
};
