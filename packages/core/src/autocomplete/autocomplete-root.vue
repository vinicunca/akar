...
export interface AAutocompleteRootProps extends APrimitiveProps {
...
export type AAutocompleteRootEmits = {
...
export type AAutocompleteRootContext = {
  modelValue: Ref<string>;
};

export const [
  injectAAutocompleteRootContext,
  provideAAutocompleteRootContext,
] = createContext<AAutocompleteRootContext>('AutocompleteRoot');
</script>

<script setup lang="ts">
import { createEventHook, useVModel } from '@vueuse/core';
import { computed, getCurrentInstance, nextTick, onMounted, ref, toRefs } from 'vue';
import { provideComboboxRootContext } from '../combobox/combobox-root.vue';
