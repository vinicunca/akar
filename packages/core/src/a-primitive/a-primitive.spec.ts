...
import { APrimitive } from '.';

describe('test APrimitive functionalities', () => {
  it('should render div element correctly', () => {
    const wrapper = mount(APrimitive);
  ...
  it('should render self closing tags element correctly', () => {
    const wrapper = mount(APrimitive, {
      props: {
        as: 'img',
      },
  ...
  describe('render as template (asChild)', () => {
    ...
    it('should render the child component', () => {
      ...
      const RootComponent = {
        components: { ChildComponent, APrimitive },
        template: '<APrimitive><ChildComponent /></APrimitive>',
      };
