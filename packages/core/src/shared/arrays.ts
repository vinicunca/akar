 ...
 */
export function areEqual(arrayA: Array<any>, arrayB: Array<any>): boolean {
 ...
 * in the array.
 * @param array - The `array` parameter is an array of values of type `T`.
 * @param start - The `start` parameter is the value that marks the beginning of the range you want
 * to find in the array.
 * @param end - The `end` parameter in the `findValuesBetween` function represents the end value
