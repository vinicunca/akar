 ...
 * @param value - The `value` parameter represents the number that you want to clamp within
 * the specified range defined by `min` and `max` values.
 * @param min - If the `value` parameter is less than the `min` value, the
 * function will return the `min` value.
 * @param max - If the `value` parameter is greater than the `max` value,
 ...
 * @param value - The `value` parameter is the number that you want to round to a specific
 * precision based on the `step` parameter.
 * @param step - The `step` parameter in the `roundToStepPrecision` function represents the
 ...
 * @param value - The `value` parameter represents the number that you want to snap to the
 * nearest step value.
 * @param min - The `min` parameter represents the minimum value that the `value`
 ...
 * @param max - The `max` parameter represents the maximum value that the `value`
 * should be snapped to. It ensures that the snapped value does not exceed this maximum value.
 * @param step - The `step` parameter in the `snapValueToStep` function represents the
