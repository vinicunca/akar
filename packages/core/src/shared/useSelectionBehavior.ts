...
export function useSelectionBehavior<T>(
  ...
  function handleMultipleReplace(intent: 'first' | 'last' | 'prev' | 'next', currentElement: HTMLElement | Element | null, getItems: () => Array<{ ref: HTMLElement; value?: any }>, options: Array<any>) {
