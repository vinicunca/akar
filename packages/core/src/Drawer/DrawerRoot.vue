...
const contentId = useId(undefined, 'akar-drawer-content');
const titleId = useId(undefined, 'akar-drawer-title');
const descriptionId = useId(undefined, 'akar-drawer-description');
