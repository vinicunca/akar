...
describe('given a single AAccordion', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = mount(AAccordion, { attachTo: document.body });
  });
...
describe('given a multiple AAccordion', () => {
  let wrapper: VueWrapper<InstanceType<typeof AAccordion>>;
  beforeEach(() => {
    document.body.innerHTML = '';
    wrapper = mount(AAccordion, { props: { type: 'multiple' }, attachTo: document.body });
  });
