...
import ADismissableLayer from './story/_a-dismissable-layer.vue';

const OPEN_LABEL = 'Open';
const CLOSE_LABEL = 'Close';
const OUTSIDE_LABEL = 'Outside';

describe('given a default ADismissableLayer', () => {
  let wrapper: VueWrapper<InstanceType<typeof ADismissableLayer>>;
  let trigger: DOMWrapper<HTMLElement>;

  beforeEach(() => {
    document.body.innerHTML = '';
    wrapper = mount(ADismissableLayer, { attachTo: document.body, props: { openLabel: OPEN_LABEL, closeLabel: CLOSE_LABEL, outsideLabel: OUTSIDE_LABEL } });
