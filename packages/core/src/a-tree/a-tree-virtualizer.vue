<script lang="ts">
export interface ATreeVirtualizerProps {
...
import { type ATreeFlattenedItem, injectATreeRootContext } from './a-tree-root.vue';

const props = defineProps<ATreeVirtualizerProps>();

defineSlots<{
  default: (props: {
    item: ATreeFlattenedItem<Record<string, any>>;
