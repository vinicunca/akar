...
function handleKeydown(event: KeyboardEvent) {
  ...
  if ((event.target as HTMLElement).closest('[data-akar-navigation-menu]') !== menuContext.rootNavigationMenu.value) {
    return;
  }
  ...
  const newSelectedElement = useArrowNavigation({
    ...
    options: { itemsArray: candidates, loop: false, enableIgnoredElement: true },
  });
