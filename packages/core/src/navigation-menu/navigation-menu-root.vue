...
export type ANavigationMenuRootEmits = {
...
export const [
  injectANavigationMenuContext,
  provideNavigationMenuContext,
] = createContext<NavigationMenuContext>(['ANavigationMenuRoot', 'ANavigationMenuSub'], 'ANavigationMenuContext');
</script>
...
const { getItems, ACollectionSlot } = useCollection(
  { key: 'NavigationMenu', isProvider: true },
);
...
provideNavigationMenuContext({
  ...
  modelValue,
  previousValue,
  baseId: useId(undefined, 'akar-navigation-menu'),
  disableClickTrigger,
  disableHoverTrigger,
  dir,
  unmountOnHide,
