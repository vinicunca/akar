...
import ConfigProviderTest from './_config-provider.story.vue';
...
describe('given a default AConfigProvider', async () => {
...
describe('given a dir="rtl" AConfigProvider', async () => {
  beforeEach(() => {
    document.body.innerHTML = '';
...
describe('given a scrollBody AConfigProvider', async () => {
  beforeEach(() => {
    document.body.innerHTML = '';
  });
