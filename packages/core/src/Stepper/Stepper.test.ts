...
function setup(props: { stepperProps?: StepperRootProps & { steps: Array<{ step: number; title: string; description: string; icon: string; isCompleted?: boolean }> }; emits?: { 'onUpdate:modelValue'?: (data: number) => void } } = {}) {
