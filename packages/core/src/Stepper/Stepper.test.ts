import type { AStepperRootProps } from './stepper-root.vue';
...
function setup(props: { stepperProps?: AStepperRootProps & { steps: Array<{ step: number; title: string; description: string; icon: string; isCompleted?: boolean }> }; emits?: { 'onUpdate:modelValue'?: (data: number) => void } } = {}) {
