...
const props = defineProps<{ stepperProps?: StepperRootProps & { steps: Array<{ step: number; title: string; description: string; icon: string; isCompleted?: boolean }> }; emits?: { 'onUpdate:modelValue'?: (data: number) => void } }>();
const steps = [{
  step: 1,
  title: 'Address',
