...
export const [injectAToastProviderContext, provideToastProviderContext]
  = createContext<ToastProviderContext>('AToastProvider');
</script>
...
const props = withDefaults(defineProps<AToastProviderProps>(), {
  label: 'Notification',
  duration: 5000,
