...
export interface AYearPickerRootProps extends APrimitiveProps {
...
export type AYearPickerRootEmits = {
...
export const [
  injectAYearPickerRootContext,
  provideAYearPickerRootContext,
] = createContext<AYearPickerRootContext>('AYearPickerRoot');
</script>
...
const emits = defineEmits<AYearPickerRootEmits>();
defineSlots<{
  default?: (props: {
...
const headingId = useId(undefined, 'akar-year-picker-heading');
