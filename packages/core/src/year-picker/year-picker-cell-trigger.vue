...
export interface AYearPickerCellTriggerProps extends APrimitiveProps {
  /** The date value provided to the cell trigger */
  year: DateValue;
}

export interface AYearPickerCellTriggerSlot {
  default?: (props: {
    /** Current year value */
    yearValue: string;
...
defineSlots<AYearPickerCellTriggerSlot>();
...
<template>
  <APrimitive
    ...
    data-akar-year-picker-cell-trigger
