...
export interface AYearPickerNextProps extends APrimitiveProps {
  /** The function to be used for the next page. Overwrites the `nextPage` function set on the `AYearPickerRoot`. */
...
defineOptions({ name: 'AYearPickerNext' });

const props = withDefaults(
  defineProps<AYearPickerNextProps>(),
  { as: 'button' },
);
