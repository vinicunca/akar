<script lang="ts">
type AScrollbarAreaScrollbarImplEmits = {
...
export interface AScrollAreaScrollbarImplProps {
...
import { toInt } from './a-scroll.utils';
...
const props = defineProps<AScrollAreaScrollbarImplProps>();
const emit = defineEmits<AScrollbarAreaScrollbarImplEmits>();
