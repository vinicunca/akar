...
import AScrollArea from './story/_a-scroll-area.vue';

describe('given default ScrollArea', () => {
  let wrapper: VueWrapper<InstanceType<typeof AScrollArea>>;

  beforeEach(() => {
    wrapper = mount(AScrollArea, { attachTo: document.body });
...
describe('given prop:type="always" ScrollArea', () => {
  ...
  beforeEach(() => {
    wrapper = mount(AScrollArea, { attachTo: document.body, props: { type: 'always' } });
    Object.defineProperty(HTMLElement.prototype, 'offsetHeight', { configurable: true, value: 500 });
    Object.defineProperty(HTMLElement.prototype, 'offsetWidth', { configurable: true, value: 500 });
    Object.defineProperty(HTMLElement.prototype, 'scrollHeight', { configurable: true, value: 2000 });
    Object.defineProperty(HTMLElement.prototype, 'scrollWidth', { configurable: true, value: 2000 });
...
describe('given prop:type="scroll" ScrollArea', () => {
  ...
  beforeEach(() => {
    wrapper = mount(AScrollArea, { attachTo: document.body, props: { type: 'scroll' } });
    Object.defineProperty(HTMLElement.prototype, 'offsetHeight', { configurable: true, value: 500 });
    Object.defineProperty(HTMLElement.prototype, 'offsetWidth', { configurable: true, value: 500 });
    Object.defineProperty(HTMLElement.prototype, 'scrollHeight', { configurable: true, value: 2000 });
    Object.defineProperty(HTMLElement.prototype, 'scrollWidth', { configurable: true, value: 2000 });
