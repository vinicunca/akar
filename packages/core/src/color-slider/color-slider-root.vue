...
export interface AColorSliderRootProps extends APrimitiveProps, FormFieldProps {
...
export type AColorSliderRootEmits = {
...
export interface AColorSliderRootContext {
  color: Ref<Color>;
...
export const [
  injectAColorSliderRootContext,
  provideAColorSliderRootContext,
] = createContext<AColorSliderRootContext>('AColorSliderRoot');
</script>
...
import { ASliderRoot } from '../slider';
...
const props = withDefaults(
  defineProps<AColorSliderRootProps>(),
  {
    colorSpace: 'hsl',
...
const emits = defineEmits<AColorSliderRootEmits>();
...
function handleValueCommit(values: Array<number>) {
