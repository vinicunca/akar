...
interface ASelectItemAlignedPositionContext {
  contentWrapper?: Ref<HTMLElement | undefined>;
  onScrollButtonChange: (node?: HTMLElement) => void;
  shouldExpandOnScrollRef?: Ref<boolean>;
}

export interface ASelectItemAlignedPositionProps extends APrimitiveProps {}

export const [
  injectASelectItemAlignedPositionContext,
  provideASelectItemAlignedPositionContext,
] = createContext<ASelectItemAlignedPositionContext>('ASelectItemAlignedPosition');
</script>
...
const props = defineProps<ASelectItemAlignedPositionProps>();
