...
export const [injectAScrollAreaRootContext, provideScrollAreaRootContext]
  = createContext<ScrollAreaRootContext>('AScrollAreaRoot');
...
defineExpose({
  /** AViewport element within ScrollArea */
  viewport,
...
<template>
  <APrimitive
    ...
    :style="{
      ...
      ['--akar-scroll-area-corner-width' as any]: `${cornerWidth}px`,
      ['--akar-scroll-area-corner-height' as any]: `${cornerHeight}px`,
    }"
  >
    <slot />
  </APrimitive>
