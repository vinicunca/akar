...
interface ConvertConstraintsToPercentOptions {
...
export function convertPanelConstraintsToPercent({
  panelDataArray,
  groupSizeInPixels,
}: ConvertConstraintsToPercentOptions): Array<PanelConstraints> | null {
...
interface RecalculateLayoutOptions {
  layout: Array<number>;
  panelDataArray: Array<PanelData>;
...
export function hasPixelSizedPanel(panelDataArray: Array<PanelData>): boolean {
...
export function recalculateLayoutForPixelPanels({
  ...
  prevGroupSize,
  nextGroupSize,
}: RecalculateLayoutOptions): Array<number> | null {
  ...
  const pixelPanelIndices = panelDataArray.reduce<Array<number>>((indices, panelData, index) => {
