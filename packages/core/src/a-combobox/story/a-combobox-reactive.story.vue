    ...
    <Variant title="default">
      <div class="flex flex-col">
        ...
        <AComboboxRoot
          ...
          ignore-filter
        >
          <AComboboxAnchor class="h-[35px] min-w-[160px] w-full inline-flex items-center justify-between gap-[5px] rounded bg-white px-[15px] text-[13px] text-grass11 leading-none shadow-[0_2px_10px] shadow-black/10 outline-none hover:bg-mauve3 data-[placeholder]:text-grass9 focus:shadow-[0_0_0_2px] focus:shadow-black">
            <AComboboxInput
              v-model="searchTerm"
              class="w-full bg-transparent text-grass11 outline-none placeholder-gray-400"
              placeholder="Test"
            />
            <AComboboxTrigger>
              <i
