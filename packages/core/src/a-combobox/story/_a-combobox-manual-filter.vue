...
const props = defineProps<{ input?: AComboboxInputProps } & AComboboxRootProps>();
const people = [
...
const filteredPeople = computed(() => people.filter((p) => startsWith({ string: p.name, substring: query.value })));
</script>
