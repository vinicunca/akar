...
describe('a-focus-scope', () => {
  describe('given a default AFocusScope', () => {
  ...
  describe('given a AFocusScope where the first focusable has a negative tabindex', () => {
    let rendered: RenderResult;
    let tabbableSecond: HTMLInputElement;
    let tabbableLast: HTMLButtonElement;
  ...
  describe('given a AFocusScope with internal focus handlers', () => {
