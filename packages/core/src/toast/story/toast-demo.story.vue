...
<template>
  ...
  >
    <AToastProvider swipe-direction="left">
      ...
      <AToastRoot
        v-model:open="open"
        class="data-[state=open]:animate-slideIn data-[state=closed]:animate-hide data-[swipe=cancel]:transition-[transform_200ms_ease-out] data-[swipe=end]:animate-swipeOut p-[15px] rounded-md bg-white gap-x-[15px] grid grid-cols-[auto_max-content] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] [grid-template-areas:_'title_action'_'description_action'] items-center data-[swipe=cancel]:translate-x-0 data-[swipe=move]:translate-x-[var(--akar-toast-swipe-move-x)]"
      >
