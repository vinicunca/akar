...
import { isBoolean, isNullish, isNumber, isObjectType, isString } from '@vinicunca/perkakas';
...
const parsedValue = computed(() => {
  ...
  } else if (props.value !== null && isObjectType(props.value) && !Array.isArray(props.value)) {
    // if object value
