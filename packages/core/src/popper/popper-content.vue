...
export const [injectPopperContentContext, providePopperContentContext]
  = createContext<PopperContentContext>('APopperContent');
</script>
...
<template>
  <div
    ...
    :style="{
      ...
      // as if the APopperContent isn't there at all
  ...
  >
    <APrimitive
      ...
      :style="{
        // if the APopperContent hasn't been placed yet (not all measurements done)
