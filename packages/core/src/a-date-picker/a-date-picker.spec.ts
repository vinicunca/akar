...
import type { ADatePickerRootProps } from './a-date-picker-root.vue';

import DatePicker from './story/_a-date-picker.vue';
...
function setup(props: { datePickerProps?: ADatePickerRootProps; emits?: { 'onUpdate:modelValue'?: (data: DateValue) => void } } = {}) {
