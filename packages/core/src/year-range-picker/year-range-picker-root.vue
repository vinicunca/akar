...
type AYearRangePickerRootContext = {
...
export interface AYearRangePickerRootProps extends APrimitiveProps {
...
export type AYearRangePickerRootEmits = {
...
export const [
  injectAYearRangePickerRootContext,
  provideAYearRangePickerRootContext,
] = createContext<AYearRangePickerRootContext>('YearRangePickerRoot');
</script>
...
const emits = defineEmits<AYearRangePickerRootEmits>();
...
const headingId = useId(undefined, 'akar-year-range-picker-heading');
