...
<template>
  ...
  >
    ...
    <Variant title="With Unmount Animation">
      <Animation class="data-[state=closed]:animate-fade-out" />
    </Variant>
    ...
    <Variant title="With Open & Close Animation">
      <Animation
        class="data-[state=closed]:animate-fade-out data-[state=open]:animate-fade-in"
      />
    </Variant>
    ...
    <Variant title="With Deferred Mount Animation">
      <div>
        ...
        <APresence :present="open">
          <div
            ref="node"
            :class="animate ? 'animate-fade-in' : undefined"
          >
            Content
          </div>
        </APresence>
