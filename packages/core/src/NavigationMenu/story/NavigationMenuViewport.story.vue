    ...
    <Variant title="Default">
      <StoryFrame>
        ...
        >
          ...
          >
            <NavigationMenuViewport
              class="data-[state=open]:animate-scaleIn data-[state=closed]:animate-scaleOut relative mt-[10px] h-[var(--akar-navigation-menu-viewport-height)] w-full origin-[top_center] overflow-hidden rounded-[6px] bg-white transition-[width,_height] duration-300 sm:w-[var(--akar-navigation-menu-viewport-width)] min-w-[400px]"
            />
          </div>
        </NavigationMenuRoot>
      </StoryFrame>
