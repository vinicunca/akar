...
<template>
  <Story
    title="Navigation Menu/Alignment"
        ...
        >
          ...
          >
            <NavigationMenuItem>
              ...
              >
                <ul
                  class="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[200px]"
                >
            ...
            <NavigationMenuItem>
              ...
              >
                <ul
                  class="m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[300px] sm:grid-flow-col sm:grid-rows-3"
                >
            ...
            <NavigationMenuItem>
              ...
              >
                ...
                >
                  ...
                  >
                    Akar releases and their changelogs.
                  </NavigationMenuListItem>
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
            ...
            <NavigationMenuIndicator
              class="absolute data-[state=hidden]:opacity-0 duration-200 data-[state=visible]:animate-fadeIn data-[state=hidden]:animate-fadeOut top-full w-[--akar-navigation-menu-indicator-size] translate-x-[--akar-navigation-menu-indicator-position] mt-[1px] z-[100] flex h-[10px] items-end justify-center overflow-hidden transition-[all,transform_250ms_ease]"
            >
          ...
          >
            <div class="relative w-full">
              <NavigationMenuViewport
                class="data-[state=open]:animate-scaleIn data-[state=closed]:animate-scaleOut absolute top-0 h-[var(--akar-navigation-menu-viewport-height)] origin-[top_center] w-full overflow-hidden rounded-[6px] bg-white transition-[width,_height,_left] duration-300 sm:w-[var(--akar-navigation-menu-viewport-width)] left-[var(--akar-navigation-menu-viewport-left)]"
              />
            </div>
          </div>
        </NavigationMenuRoot>
