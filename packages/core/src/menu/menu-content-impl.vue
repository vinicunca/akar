...
export interface MenuContentImplPrivateProps {
  ...
  /**
   * Whether scrolling outside the `AMenuContent` should be prevented
   * @defaultValue false
   */
...
export type MenuContentImplEmits = DismissableLayerEmits & Omit<ARovingFocusGroupEmits, 'update:currentTabStopId'> & {
...
function handleKeyDown(event: KeyboardEvent) {
  ...
  const isKeyDownInside
    = target.closest('[data-akar-menu-content]') === event.currentTarget;
