...
<template>
  ...
  >
    <Variant title="Uncontrolled (Single)">
      <AListboxRoot class="mx-auto h-72 w-48 flex flex-col overflow-auto border rounded-lg bg-white p-1 color-green9">
        <AListboxContent>
          <AListboxItem
            v-for="i in options"
            :key="i"
    ...
    <Variant title="Orientation (Horizontal)">
      <AListboxRoot
        class="mx-auto h-full w-64 flex flex-col overflow-auto border rounded-lg bg-white p-1 color-green9"
