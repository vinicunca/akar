...
<template>
  ...
  >
    <Variant title="Filter (Single)">
      <AListboxRoot class="text-green9 mx-auto p-1 border rounded-lg bg-white flex flex-col w-48">
        <AListboxFilter
          v-model="searchTerm"
    ...
    <Variant title="Filter (Multiple)">
      <AListboxRoot
        :multiple="true"
        class="text-green9 mx-auto p-1 border rounded-lg bg-white flex flex-col w-48"
      >
        <AListboxFilter
          v-model="searchTerm"
          class="border rounded"
