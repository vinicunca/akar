...
watch(
  ...
  // This is uncommon but may happen if people are trying to implement pixel based constraints.
    if (
      ...
      reevaluatePanelConstraints({ panelData: panelDataRef.value, prevConstraints });
    }
  },
  { deep: true },
);
...
const style = computed(() => getPanelStyle({
  panelData: panelDataRef.value,
  defaultSize: props.defaultSize,
}));
...
defineExpose({
  ...
  resize: (size: number) => {
    resizePanel({ panelData: panelDataRef.value, unsafePanelSize: size });
  },
