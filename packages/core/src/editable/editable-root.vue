...
export const [injectAEditableRootContext, provideEditableRootContext]
  = createContext<EditableRootContext>('AEditableRoot');
</script>
...
const props = withDefaults(defineProps<AEditableRootProps>(), {
  as: 'div',
  disabled: false,
  submitMode: 'blur',
