...
import type { AMonthRangePickerRootProps } from './month-range-picker-root.vue';
...
import MonthRangePicker from './story/_month-range-picker.vue';
...
function setup(props: { pickerProps?: AMonthRangePickerRootProps; emits?: { 'onUpdate:modelValue'?: (data: DateRange) => void } } = {}) {
