...
type AMonthRangePickerRootContext = {
...
export interface AMonthRangePickerRootProps extends APrimitiveProps {
...
export type AMonthRangePickerRootEmits = {
...
export const [
  injectAMonthRangePickerRootContext,
  provideAMonthRangePickerRootContext,
] = createContext<AMonthRangePickerRootContext>('AMonthRangePickerRoot');
</script>
...
import { useMonthPicker } from '../month-picker/use-month-picker';
...
const emits = defineEmits<AMonthRangePickerRootEmits>();
...
const headingId = useId(undefined, 'akar-month-range-picker-heading');
