...
import { hasTime, isZonedDateTime, toDate } from './comparators.date';
...
export interface UseDateFormatter {
  ...
  part: (params: { dateObj: DateValue; options?: DateFormatterOptions; type: Intl.DateTimeFormatPartTypes }) => string;
