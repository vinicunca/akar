...
type Field = 'day' | 'dayPeriod' | 'era' | 'hour' | 'minute' | 'month' | 'second' | 'year';
...
type SupportedLocaleString = ({} & string) | SupportedLocale;
...
function isDefaultField(field: unknown): field is 'dayPeriod' | 'era' {
...
function getPlaceholderObj(locale: SupportedLocaleString) {
