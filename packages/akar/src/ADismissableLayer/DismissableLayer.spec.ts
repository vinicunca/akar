...
import ADismissableLayer from './story/_ADismissableLayer.vue';
...
describe('given a default DismissableLayer', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = mount(ADismissableLayer, { attachTo: document.body, props: { closeLabel: CLOSE_LABEL, openLabel: OPEN_LABEL, outsideLabel: OUTSIDE_LABEL } });
