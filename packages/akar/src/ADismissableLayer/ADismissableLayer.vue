...
// TODO AFTER LUNCH, RENAME THIS TO ADismissableLayer
...
export type ADismissableLayerEmits = {
  /**
...
const props = withDefaults(defineProps<ADismissableLayerProps>(), {
  disableOutsidePointerEvents: false,
});

const emits = defineEmits<ADismissableLayerPrivateEmits>();

const { currentElement: layerElement, forwardRef } = useForwardExpose();
