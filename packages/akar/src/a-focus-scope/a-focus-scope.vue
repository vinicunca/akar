...
export interface AFocusScopeProps extends APrimitiveProps {
  /**
   * When `true`, tabbing from last item will Afocus first tabbable
   * and shift+tab from first item will Afocus last tababble.
   * @defaultValue false
   */
  loop?: boolean;

  /**
   * When `true`, Afocus cannot escape the Afocus scope via keyboard,
   * pointer, or a programmatic Afocus.
   * @defaultValue false
   */
  trapped?: boolean;
}
