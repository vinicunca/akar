...
import ADummyDialog from './_dummy-a-dialog.vue';
import ADummyPopover from './_dummy-a-popover.vue';
    ...
    <Variant title="Dialog (with scrollbar)">
      <div class="flex flex-col gap-4">
        ...
        <template v-if="open">
          <Teleport to="body">
            <div
              class="pointer-events-none fixed bottom-0 left-0 right-0 top-0 flex items-center justify-center overflow-y-auto bg-black/30"
            >
