...
export function getNavigationMenuTheme(
  { brands, configs = {} }: ThemeParams,
) {
  return defuFn(
    configs.navigationMenu ?? {},
    {
      slots: {
        ...
        item: 'min-w-0',
        link: 'group text-sm font-medium flex gap-1.5 w-full items-center relative focus-visible:(outline-none before:ring-2 before:ring-inset) focus:outline-none before:(rounded-md content-empty absolute -z-1) dark:focus-visible:outline-none',
        ...
        childItem: '',
        childLink: 'group text-sm text-start flex size-full items-start relative focus-visible:(outline-none before:ring-2 before:ring-inset) focus:outline-none before:(rounded-md absolute -z-1) dark:focus-visible:outline-none',
      ...
      compoundVariants: [
        ...
        },
        {
          ...
          collapsed: false,
          class: {
            childList: 'ms-5 border-s border-background',
        ...
        },
        {
          ...
          highlight: true,
          class: {
            link: 'after:(rounded-full h-px block transition-colors inset-x-2.5 absolute -bottom-2)',
          },
        },
        {
          orientation: 'vertical',
          ...
          level: true,
          class: {
            link: 'after:(rounded-full w-px block transition-colors inset-y-0.5 absolute -start-1.5)',
          },
        },
        {
          disabled: false,
