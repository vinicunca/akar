...
export const stepperTheme = {
  ...
  variants: {
    ...
    color: {
      ...
      neutral: {
        trigger: 'group-data-[state=completed]:bg-background-inverted group-data-[state=active]:bg-background-inverted focus-visible:outline-outline-inverted',
...
} satisfies UvConfig<typeof pohon>['stepper'];
