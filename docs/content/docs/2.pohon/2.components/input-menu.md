...
::note
In this example, leveraging [`defineShortcuts`](/docs/pohon/composables/define-shortcuts), you can toggle the InputMenu by pressing :kbd{value="O"}.
::
...
:docs-akar-to-pohon{to="/docs/akar/components/combobox" mode="pohon"}
