...
You can customize this icon globally in your `app.config.ts` under `pohon.icons.success` key.
:::

#vue
:::tip{to="/docs/getting-started/integrations/icons/vue#theme"}
You can customize this icon globally in your `vite.config.ts` under `pohon.icons.success` key.
:::
::
