...
A modern UI library built on [Akar](/docs/akar), [UnoCSS](https://unocss.dev/), and [UnoCSS Variants](https://vinicunca.dev/unocss-variants) to ship beautiful and accessible applications with 100+ production-ready components.
...
Pohon UI is built on top of [Akar](/docs/akar) as a foundation for the components:
