...
::warning
If you're using **pnpm**, ensure that you either set [`shamefully-hoist=true`](https://pnpm.io/npmrc#shamefully-hoist) in your `.npmrc` file or install `unocss`, `vue-router` and `@unhead/vue` in your project's root directory.
::
