---
title: Contribution
description: 'A comprehensive guide on contributing to Pohon UI, including project structure, development workflow, and best practices.'
navigation.icon: 'i-lucide:handshake'
---

Pohon UI thrives thanks to its incredible community ❤️. We welcome all contributions through bug reports, pull requests, and feedback to help make this library even better.

::caution
Before reporting a bug or requesting a feature, make sure that you have read through our [documentation](https://pohon.nuxt.com/) and existing [issues](https://github.com/nuxt/ui/issues?q=is%3Aissue%20is%3Aopen%20sort%3Aupdated-desc).
::

## Project structure

Here's an overview of the key directories and files in the Pohon UI project structure:
...
To make development easier, we've created a CLI that you can use to generate components and locales. You can access it using the `pohon-ui make` command.
...
```sh
pohon-ui make component <name> [options]
```
...
pohon-ui make component my-component

# Create a prose component
pohon-ui make component heading --prose

# Create a content component
pohon-ui make component block --content

# Generate only documentation template
pohon-ui make component my-component --template=docs
```
...
```sh
pohon-ui make locale --code <code> --name <name>
```

::note{to="/docs/pohon/getting-started/integrations/i18n/nuxt#supported-languages"}
...
#### Clone the `pohon-ui` repository to your local machine

```sh
git clone -b main https://github.com/vinicunca/akar.git
```
...
- Follow along the [instructions](https://github.com/vinicunca/akar/blob/main/packages/pohon/.github/PULL_REQUEST_TEMPLATE.md?plain=1) provided when creating a PR
