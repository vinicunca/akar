---
title: CSS Variables
description: Pohon UI uses CSS variables as design tokens for flexible, consistent theming with built-in light and dark mode support.
...
Pohon UI provides Tailwind CSS utility classes for each [semantic color](/docs/getting-started/theme/design-system#semantic-colors) you define, allowing you to use class names like `text-error` or `bg-success`:
...
Pohon UI provides Tailwind CSS utility classes for text colors, allowing you to use class names like `text-dimmed` or `text-muted`:
...
[Text]{class="color-text text-sm px-4 py-1.5 inline-block rounded-md"}
...
Pohon UI provides Tailwind CSS utility classes for background colors, allowing you to use class names like `bg-background` or `bg-muted`:

::code-preview
[Default]{class="bg-background text-sm px-4 py-1.5 inline-block rounded-md mr-2"}
...
```vue
<template>
  <div class="bg-background">Default</div>
...
Pohon UI provides Tailwind CSS utility classes for border colors, allowing you to use class names like `border-border` or `border-muted`:

::code-preview
[Default]{class="border-2 border-border text-sm px-4 py-1.5 inline-block rounded-md mr-2"}
[Muted]{class="border-2 border-muted text-sm px-4 py-1.5 inline-block rounded-md mr-2"}
[Accented]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-md mr-2"}
...
<template>
  ...
  <div class="border border-border-accented">Accented</div>
...
Pohon UI overrides Tailwind CSS's default `rounded-*` utilities with a unified border radius system, allowing you to use regular [border radius utilities](https://tailwindcss.com/docs/border-radius) like `rounded-xs` or `rounded-2xl`:

::code-preview
[xs]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-xs mr-2"}
[sm]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-sm mr-2"}
[md]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-md mr-2"}
[lg]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-lg mr-2"}
[xl]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-xl mr-2"}
[2xl]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-2xl mr-2"}
[3xl]{class="border-2 border-border-accented text-sm px-4 py-1.5 inline-block rounded-3xl mr-2"}
...
Pohon UI provides a `--ui-container` CSS variable that controls the maximum width of the [Container](/docs/pohon/components/container) component.
...
Pohon UI provides a `--pohon-header-height` CSS variable that controls the height of the [Header](/docs/pohon/components/header) component.

```css
:root {
  --pohon-header-height: --spacing(16);
}
```
...
:root {
  --pohon-header-height: --spacing(24);
}
```
::
...
Pohon UI applies default classes on the `<body>`{lang="html"} element of your app for consistent theming across light and dark modes:
