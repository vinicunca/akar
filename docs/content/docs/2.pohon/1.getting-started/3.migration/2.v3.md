...
5. Wrap your app with the [App](/docs/pohon/components/app) component:
...
```diff
<template>
- <PButton :pohon="{ font: 'font-bold' }" />
+ <PButton :pohon="{ base: 'font-bold' }" />
</template>
```

::tip{to="/docs/pohon/components/button#theme"}
...
| v2 | v3 |
| --- | --- |
| `Divider` | [`Separator`](/docs/pohon/components/separator) |
| `Dropdown` | [`DropdownMenu`](/docs/pohon/components/dropdown-menu) |
| `FormGroup` | [`FormField`](/docs/pohon/components/form-field) |
| `Range` | [`Slider`](/docs/pohon/components/slider) |
| `Toggle` | [`Switch`](/docs/pohon/components/switch) |
| `Notification` | [`Toast`](/docs/pohon/components/toast) |
| `VerticalNavigation` | [`NavigationMenu`](/docs/pohon/components/navigation-menu) with `orientation="vertical"` |
| `HorizontalNavigation` | [`NavigationMenu`](/docs/pohon/components/navigation-menu) with `orientation="horizontal"` |

Here are the Nuxt UI Pro components that have been renamed or removed:

| v1 | v3 |
| --- | --- |
| `BlogList` | [`BlogPosts`](/docs/pohon/components/blog-posts) |
| `ColorModeToggle` | [`ColorModeSwitch`](/docs/pohon/components/color-mode-switch) |
| `DashboardCard` | Removed (use [`PageCard`](/docs/pohon/components/page-card) instead) |
| `DashboardLayout` | [`DashboardGroup`](/docs/pohon/components/dashboard-group) |
| `DashboardModal` | Removed (use [`Modal`](/docs/pohon/components/dialog) instead) |
| `DashboardNavbarToggle` | [`DashboardSidebarToggle`](/docs/pohon/components/dashboard-sidebar-toggle) |
| `DashboardPage` | Removed |
| `DashboardPanelContent` | Removed (use `#body` slot instead) |
| `DashboardPanelHandle` | [`DashboardResizeHandle`](/docs/pohon/components/dashboard-resize-handle) |
| `DashboardSection` | Removed (use [`PageCard`](/docs/pohon/components/page-card) instead) |
| `DashboardSidebarLinks` | Removed (use [`NavigationMenu`](/docs/pohon/components/navigation-menu) instead) |
| `DashboardSlideover` | Removed (use [`Slideover`](/docs/pohon/components/slideover) instead) |
| `FooterLinks` | Removed (use [`NavigationMenu`](/docs/pohon/components/navigation-menu) instead) |
| `HeaderLinks` | Removed (use [`NavigationMenu`](/docs/pohon/components/navigation-menu) instead) |
| `LandingCard` | Removed (use [`PageCard`](/docs/pohon/components/page-card) instead) |
| `LandingCTA` | [`PageCTA`](/docs/pohon/components/page-cta) |
| `LandingFAQ` | Removed (use [`Accordion`](/docs/pohon/components/accordion) instead) |
| `LandingGrid` | Removed (use [`PageGrid`](/docs/pohon/components/page-grid) instead) |
| `LandingHero` | Removed (use [`PageHero`](/docs/pohon/components/page-hero) instead) |
| `LandingLogos` | [`PageLogos`](/docs/pohon/components/page-logos) |
| `LandingSection` | [`PageSection`](/docs/pohon/components/page-section) |
| `LandingTestimonial` | Removed (use [`PageCard`](/docs/pohon/components/page-card#as-a-testimonial) instead) |
| `NavigationAccordion` | [`ContentNavigation`](/docs/pohon/components/content-navigation) |
| `NavigationLinks` | [`ContentNavigation`](/docs/pohon/components/content-navigation) |
| `NavigationTree` | [`ContentNavigation`](/docs/pohon/components/content-navigation) |
| `PageError` | [`Error`](/docs/pohon/components/error) |
| `PricingCard` | [`PricingPlan`](/docs/pohon/components/pricing-plan) |
| `PricingGrid` | [`PricingPlans`](/docs/pohon/components/pricing-plans) |
| `PricingSwitch` | Removed (use [`Switch`](/docs/pohon/components/switch) or [`Tabs`](/docs/pohon/components/tabs) instead) |
...
```diff
<template>
- <PSelect :options="countries" />
+ <PSelect :items="countries" />

- <UHorizontalNavigation :links="links" />
+ <PNavigationMenu :items="links" />
</template>
```
...
- The global `Modals`, `Slideovers` and `Notifications` components have been removed in favor the [App](/docs/pohon/components/app) component:
...
<template>
- <PButton label="Open" @click="open = true" />
...
<template>
- <PDialog>
+ <PDialog title="Title" description="Description">
-   <div class="p-4">
+   <template #body>
      <CorePlaceholder class="h-48" />
+   </template>
