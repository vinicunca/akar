...
#### Props
:docs-props-table{name='props-date-range-picker-content' :data='[
  {
    "name": "as",
  ...
  {
    "name": "portal",
    "description": "Props to control the portal wrapped around the content.",
...
:docs-emits-table{name='events-date-range-picker-content' :data='[
  {
    "name": "closeAutoFocus",
    "description": "",
    "type": "[event: Event]"
