...
<ComponentPreview name="AccordionBase" dir="accordion" />
...
<!-- @include: @/meta/a-accordion-root.md -->
...
// index.vue
<script setup>
import { AccordionContent, AccordionHeader, AccordionItem, AccordionRoot } from 'reka-ui';
import './styles.css';
</script>
