...
Akar design pattern is to create primitives for each component, and allow user to construct or [compose](/docs/akar/guides/composition) components however they want.
