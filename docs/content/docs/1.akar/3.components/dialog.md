...
features:
  ...
  - Manages screen reader announcements with `<AADialogTitle>` and `<AADialogDescription>` components.
...
:docs-akar-to-pohon{to="/docs/pohon/components/dialog"}
...
Adheres to the [ADialog WAI-ARIA design pattern](https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/).
